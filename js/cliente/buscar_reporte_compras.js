...
function validar(){
  ...
  if (idempresa == '') {
    ...
    swal("Seleccione fecha de fin!");
	  ...
	  window.open('Buscar_reporte_compras/imprimircompras?idempresa='+idempresa+'&finicio='+finicio+'&fhasta='+fhasta);
		// $.ajax({
...
function generar_reporte(){
  ...
  window.open('Buscar_reporte_retenciones/imprimir?finicio='+finicio+'&fhasta='+fhasta);
