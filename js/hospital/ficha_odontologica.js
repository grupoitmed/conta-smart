...
function guardar_consulta() {
  if ($("#motivo_consulta").val() == "") {
    ...
    if (estado == 0) {
      $.ajax({
        url: 'ficha_odontologica/guardar_ficha',
        type: "POST",
        dataType: "json",
        data: datos,
        beforeSend: function() {
      ...
      $.ajax({
        url: 'ficha_odontologica/actualizar_consulta',
        type: "POST",
        data: datos,
        beforeSend: function() {
          $('#myModal').modal('toggle');
...
function cargar_antecedentes_odontologicos() {
  $.ajax({
    url: 'ficha_odontologica/cargar_antecedentes_odontologicos',
    type: "POST",
    data: {
      id: $("#id_e").text()
    },
    success: function(response) {
      $('#datos_antecedentes_odontologicos').html(response);
    }
  });
}
...
function cargar_odontograma(){
  var estado = $("#estado_save").val();
  $.ajax({
    url: 'ficha_odontologica/cargar_odontograma',
    type: "POST",
    data: {
      id: $("#id_e").text(),
      id_ficha: estado
    ...
    success: function(response) {
      $('#odontograma').html(response);
    }
  });

}

function modal_odonto(id,id_imagen){
  $.ajax({
    url: 'ficha_odontologica/imagen_odontograma',
    type: "POST",
    data: {id:id,id_imagen:id_imagen},
    success: function (response) {
      $('#modal').html(response);
      $('#modal').modal({
        backdrop: 'static',
...
function cambiar_imagen(id,id_imagen){
  var estado = $("#estado_save").val();
  $.ajax({
    url: 'ficha_odontologica/cambiar_imagen',
    type: "POST",
    data: {id:id,id_imagen:id_imagen,id_ficha:estado},
    success: function(response) {
      cerrar_modal();
      cargar_odontograma();
    }
