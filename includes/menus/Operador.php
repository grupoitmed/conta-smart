        ...
        <div class="sidemenu-container navbar-collapse collapse fixed-menu">
                  <div id="remove-scroll" class="left-sidemenu">
                      <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                          ...
                          <li  <?php if($opt == "dashboard" || $opt == "compras" || $opt == "nueva_empresa" || $opt == "buscar_empresa" || $opt == "ventas"){ echo 'class="nav-item start active open"';}else{ echo 'class="nav-item start acive open"'; }?>>
                              ...
                              <ul class="sub-menu">
							    <li <?php if($opt == "dashboard"){ echo 'class="nav-item active open"'; }?>>
                                      <a href="https://conta-smart.com/portal" class="nav-link ">
                                          <span class="title">Inicio</span>
                                          <span class="selected"></span>
                                      </a>
                                  </li>
                                  <li <?php if($opt == "nueva_empresa"){ echo 'class="nav-item active open"'; }?>>
                                      <a href="../administracion/Empresas" class="nav-link ">
                                ...
                                <a href="#" class="nav-link nav-toggle">
                                 ...
                                 <ul class="sub-menu">
									<li <?php if($opt == "consumidorfinal"){ echo 'class="nav-item active open"'; }?>>
									  <a href="../administracion/Buscar_reporte_ventas_consumidor_final" class="nav-link ">
										<span class="title">Libro de ventas consumidor final</span>
									  </a>
									</li>
									<li <?php if($opt == "creditofiscal"){ echo 'class="nav-item active open"'; }?>>
									  <a href="../administracion/Buscar_reporte_credito_fiscal" class="nav-link ">
