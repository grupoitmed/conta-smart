<?php
  ...
  function load_modal_ginecologia($id){ ?>
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
        <button type="button" class="close" data-dismiss="modal">x</button>
        <h2 class="semibold modal-title text-danger">Ginecología</h2>
      </div>
    <form class="form-horizontal form-bordered" id="ginecologia" name="ginecologia" action="" method="post">
      <div class="modal-body">
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              ...
              <select name="dia4" id="dia4" class="form-control select2">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <center><button class="btn btn-success" type="button" onClick="newDiagnostico();"><i class="ico-plus"></i> Agregar Diagnostico</button></center>
                        </div>
                    </div>
          <div class="form-group">
            <div class="col-sm-9">
              ...
              <!--<select id="referidog" name="referidog" >
                            </select>-->
            ...
            <div class="col-sm-12">
              ...
              <input type="text" name="indic5" id="indic5" class="form-control"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" name="endo" id="endo" class="form-control" />
                            </select>
            </div>
          </div>
                    <div class="form-group">
          ...
          <h4 class="text-primary mt0">Ovarios</h4>
          <div class="form-group">
            <div class="col-sm-12">
              <label class="control-label">Derecho:</label>
              <textarea name="oder" id="oder" class="form-control"></textarea>
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-12">
              <label class="control-label">Izquierdo:</label>
              <textarea name="oizq" id="oizq" class="form-control"></textarea>
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-12">
              <label class="control-label">FONDO DE SACO:</label>
              <textarea name="fond" id="fond" class="form-control"></textarea>
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-12">
              <label class="control-label">CUPULA:</label>
              <textarea name="cupu" id="cupu" class="form-control"></textarea>
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-12">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-success" onclick="save_ginecologia();">Guardar</button>
        </div>
      </div>
    </form>
    </div>
...
function save_ginecologia(){
  var trimestre = $('#ginecologia').serialize();
   $.ajax({
        url: 'Ficha_reporte/save_ginecologia',
        type: "POST",
        data: trimestre,
        beforeSend: function() {
            $('#modal').modal('hide');
        ...
        success: function(response) {
           if (response == 0) {
            swal({
                    title: 'Exito!',
                    text: 'Ginecología guardado correctamente!',
                    type: 'success',
                    confirmButtonColor: '#ff9933'
                }).then(function() { 
                  cargar_ginecologia(<?php echo $id; ?>);

                });
            } else {
                swal({
                    title: 'Oops...',
                    text: 'Hubo un error al guardar el Ginecología, por favor intentelo de nuevo mas tarde!',
                    type: 'error',
...
<?php }
function ver_ginecologia($idantropometria,$accion){
  $CI =& get_instance();
  $CI->load->helper('url');
  $CI->load->database();
