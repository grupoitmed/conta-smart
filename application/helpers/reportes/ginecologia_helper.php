<?php
 ...
 include 'includes/time_zone.php';
  function load_ginecologia($id){
    $CI =& get_instance();
    $CI->load->helper('url');
    $CI->load->database();
    $query = $CI->db->query("SELECT a.*, b.nombre FROM reporte5 a,usuarios b WHERE a.idexpediente=".$id." and a.idusuario=b.idUsuario ORDER BY fecha DESC");
?>
<table class="table table-striped" id="ginecologiatable">
	<thead>
    <tr>
