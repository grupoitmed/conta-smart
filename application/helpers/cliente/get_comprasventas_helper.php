...
?>
	<div class="card card-box">
		<div class="card-head" id="header_1" style="cursor:pointer;">
			...
			<div class="tools">
				...
				<a id="colapsep" class=" btn-color fa fa-chevron-up" href="javascript:;"></a>
		...
		<script>
			$(document).ready(function(){
				$("#header_1").click(function (){
					$("#bar-parent").toggle("500");
					$("#colapsep").toggleClass("fa-chevron-up");
					$("#colapsep").toggleClass("fa-chevron-down");
				});
			});
		</script>
		<div class="card-body" id="bar-parent" style="display:none;">
...
<?php $contador = 0;
		$sql = $CI->db->query("SELECT fecha_tributaria,MONTH(fecha_tributaria) mes, YEAR(fecha_tributaria) año 
									...
									GROUP BY MONTH(fecha_tributaria) ORDER BY año,mes ASC");
		...
		?>
			<tr role="row" class="even">
				...
				<td class="center">
					<!--<div class="btn-group">
						<button class="btn btn-xs btn-primary dropdown-toggle center no-margin" type="button" data-toggle="dropdown" aria-expanded="false"> Acciones
							<i class="fa fa-angle-down"></i>
						</button>
						<ul class="dropdown-menu pull-left" role="menu">
							<li>
								<a href="javascript:window.open('../administracion/Reporte_ventas_credito_fiscal?idempresa='+<?php echo $idempresa;?>+'&fhasta='+'<?php echo $ffin3;?>'+'&finicio='+'<?php echo $finicio;?>');"><i class="fa fa-handshake-o"></i>Reporte de Contribuyentes</a>
							</li>
							<li>
								<a href="javascript:window.open('../administracion/Reporte_ventas_consumidor_final?idempresa='+<?php echo $idempresa;?>+'&fhasta='+'<?php echo $ffin3;?>'+'&finicio='+'<?php echo $finicio;?>');"><i class="fa fa-book"></i>Reporte Consumidor Final</a>
							</li>
							<li>
								<a href="javascript:window.open('../administracion/Reporte_libro_compras?idempresa='+<?php echo $idempresa;?>+'&fhasta='+'<?php echo $ffin3;?>'+'&finicio='+'<?php echo $finicio;?>');"><i class="fa fa-shopping-cart"></i>Reporte de Compras</a>
							</li>
						</ul>
					</div>-->
					<div class="btn-group">
					  ...
					  <ul class="dropdown-menu" role="menu">
						  <li>
							<a href="javascript:window.open('../administracion/Reporte_ventas_credito_fiscal?idempresa=<?=md5($idempresa)?>&fhasta='+'<?php echo $ffin3;?>'+'&finicio='+'<?php echo $finicio;?>');">Ventas Contribuyentes</a>
						  </li>
						  <li>
							<a href="javascript:window.open('../administracion/Reporte_ventas_consumidor_final?idempresa=<?=md5($idempresa)?>&fhasta='+'<?php echo $ffin3;?>'+'&finicio='+'<?php echo $finicio;?>');">Ventas Consumidor Final</a>
						  </li>
						  <li>
							<a href="javascript:window.open('../administracion/Reporte_libro_compras?idempresa=<?=md5($idempresa)?>&fhasta='+'<?php echo $ffin3;?>'+'&finicio='+'<?php echo $finicio;?>');">Reporte de Compras</a>
						  </li>
						  <li>
							<a href="javascript:window.open('../cliente/Buscar_reporte_retenciones/imprimir?idempresa=<?=md5($idempresa)?>&fhasta='+'<?php echo $ffin3;?>'+'&finicio='+'<?php echo $finicio;?>');">Reporte de Retenciones</a>
						  </li>
					  </ul>
				  </div>
				</td>
