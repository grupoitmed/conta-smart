...
class Dashboard extends CI_Controller {
  ...
  public function __construct(){
		...
		$this->load->helper('cliente/get_comprasventas_helper.php');
	}
  ...
  public function index()
    ...
    if($this->session->userdata('Cliente')) {
		...
		$data['retenciones'] 			= $this->Dashboard_model->retenciones();
		...
		$data['balance_iva'] 			= $this->Dashboard_model->balance_iva() + $data['pagocuenta'];
