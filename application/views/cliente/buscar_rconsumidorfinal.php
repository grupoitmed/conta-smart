...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-dark dark-sidebar-color logo-dark dark-theme" onload="">
        ...
        <div class="page-content">
          <div class="row">
            <div class="col-sm-12">
              <div class="card-box">
                <div class="card-head">
                  <header>Reporte de venta consumidor final</header>
				</div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
						  ...
						  <input size="30" type="text" value="<?php echo MD5($idempresa);?>" class="hidden" id="idempresa" name="idempresa" readonly>
                        </div>
                      </div>
                    </div>
  ...
  <script src="<?php echo base_url();?>js/cliente/buscar_reventafiscal.js" type="text/javascript">
  </script>
</body>
</html>
