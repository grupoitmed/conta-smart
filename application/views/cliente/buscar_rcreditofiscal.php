...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-dark dark-sidebar-color logo-dark dark-theme" onload="">
  <div class="page-wrapper">
    ...
    <div class="page-container">
      <?php $opt = "ccf"; include "includes/menus/".$user_data['menu'];?>
      <!-- end sidebar menu -->
      <!-- start page content -->
        ...
        <div class="page-content">
          <div class="row">
            <div class="col-sm-12">
              <div class="card-box">
                <div class="card-head">
                  <header>Reporte de venta credito fiscal</header>
				</div>
  ...
  <script src="<?php echo base_url();?>js/cliente/buscar_rcreditofiscal.js" type="text/javascript">
  </script>
</body>
</html>
