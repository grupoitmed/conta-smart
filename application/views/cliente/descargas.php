...
<!-- END HEAD -->
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-dark dark-sidebar-color logo-dark dark-theme" onload="load_archivos();">
  <div class="page-wrapper">
    ...
    <div class="page-container">
      <?php $opt = "descargas"; include "includes/menus/".$user_data['menu'];?>
      <!-- end sidebar menu -->
      <!-- start page content -->
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="fechacompra">¿Que desea descargar?</label>
						  <select class="form-control" name="tipo_documento" id="tipo_documento" onchange="load_archivos();">
  ...
  <script src="<?php echo base_url();?>/js/cliente/descargas.js"></script>
  </script>
</body>
</html>
