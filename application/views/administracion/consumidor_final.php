...
<!-- END HEAD -->
<body onload="load_facturascf('<?=$fhasta?>','<?=$finicio?>',<?=$id?>);" class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-dark dark-sidebar-color logo-dark dark-theme">
...
<form class="form-inline" id="frm_venta">	
			<div class="row">
				...
				<div class="col-md-3 hidden" id="hinit">
					...
					<label class="col-md-3">NIT</label>
						<input type="number" value="" step="any" id="nit" name="nit" class="form-control" data-mask="$ 999,999,999.99" placeholder="NIT">
					</div>
				</div>
				...
				<div class="col-md-3">
					<div class="form-group">
					<label>&nbsp;# Factura&nbsp;</label>
						<input type="number" value="" id="numerofactura" name="numerofactura" class="form-control" onblur="verificar_fecha_factura();">
					</div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
				...
				<span id="textfactura">Factura activa</span>
                  ...
                  <div class="col-lg-12 p-t-20" align="center">
                    <button type="button" class="btn btn-round btn-primary" onclick="verificar_consumidor();">Verificar</button>
                    <button type="button" class="btn btn-round btn-success" onclick="guardarconsumidorfinal();">Guardar</button>
                    <button type="button" class="btn btn-round btn-danger" onclick="salir();">Cancelar</button>
                   </div>
                    </form>
					<div class="table-responsive" id="ventascf"></div>
                  </div>
                </div>
              </div>
            </div>
	...
	<div class="modal modal-fade" id="modal"></div>
      ...
      <div class="page-footer">
        <div class="page-footer-inner"> <?php echo date('Y')?> &copy; CONTA-SMART
