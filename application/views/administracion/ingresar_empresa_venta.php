            ...
            <div class="page-content">
              <div class="row">
                <div class="col-sm-12">
                  <div class="card-box">
                    <div class="card-head">
                      <header>Buscar empresa para ingresar ventas</header>
                    </div>
                    <div class="card-body row">
						<div class="col-md-6 text-center" align="center">
							<input type="text" class="form-control" onkeyup="buscar_empresa_trabajar_venta(this.value);" placeholder="Buscar">
						</div>
                    </div>
                  </div>
                </div>
