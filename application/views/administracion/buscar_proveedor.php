  ...
  <div class="page-wrapper">
    <!-- start header -->
        ...
        <div class="page-container">
          <?php $opt = "buscar_proveedor"; include "includes/menus/".$user_data['menu'];?>
          <!-- end sidebar menu -->
          <!-- start page content -->
            ...
            <div class="page-content">
              <div class="row">
                <div class="col-sm-12">
                  <div class="card-box">
                    <div class="card-head">
                      <header>Buscar proveedores</header>
                    </div>
					
                    <div class="card-body row">
						<div class="col-md-6 text-center" align="center">
							<input type="text" class="form-control" onkeyup="cargar_proveedores(this.value);" placeholder="Buscar">
						</div>
                    </div>
					
                  </div>
                </div>
                <div class="table-responsive" id="datos_proveedor">
                </div>
              </div>
		...
		<div style="color:#000;" class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            ...
            <script src="<?php echo base_url();?>js/administrador/proveedores.js" type="text/javascript">
