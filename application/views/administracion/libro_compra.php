...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-dark dark-sidebar-color logo-dark dark-theme" onload="load_empresa();">
  <div class="page-wrapper">
    ...
    <div class="page-container">
      <?php $opt = "libro_compras"; include "includes/menus/".$user_data['menu'];?>
      <!-- end sidebar menu -->
      <!-- start page content -->
        ...
        <div class="page-content">
          <div class="row">
            <div class="col-sm-12">
              <div class="card-box">
                <div class="card-head">
                  <header>Buscar Empresa para crear libro de compras</header>
                </div>
                <div class="card-body row container">
                  <form id="frm_compras" class="" action="../libros/reporte_libro_compras" method="POST" target="_blank">
                    <div class="row">
                      <div class="col-lg-4">
                    ...
                    <div class="col-lg-12 p-t-20 text-center">
                      <button type="button" class="btn btn-round btn-success" onclick="validar();"><i class="fa fa-print"></i> Generar</button>
