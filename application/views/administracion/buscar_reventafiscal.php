...
<!-- END HEAD -->
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-dark dark-sidebar-color logo-dark dark-theme" onload="load_empresa();">
  <div class="page-wrapper">
    ...
    <div class="page-container">
      <?php $opt = "creditofiscal"; include "includes/menus/".$user_data['menu'];?>
      <!-- end sidebar menu -->
      <!-- start page content -->
        ...
        <div class="page-content">
          <div class="row">
            <div class="col-sm-12">
              <div class="card-box">
                <div class="card-head">
                  <header>Buscar Empresa para crear reporte de venta credito fiscal</header>
                </div>
                <div class="card-body row container">
                  <form id="frm_ventafiscal" class="" action="Reporte_ventas_credito_fiscal" method="POST" target="_blank">
                    <div class="row">

                      <div class="col-md-4">
                        <div class="form-group">
                          <label>Empresa</label>
                          <select class="form-control select2" id="idempresa" name="idempresa">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <div class="input-append date form_date" data-date-format="dd-mm-yyyy">
                            <input size="30" type="text" value="" class="form-control" id="finicio" name="finicio" readonly>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label>Hasta</label>
                          <div class="input-append date form_date" data-date-format="dd-mm-yyyy">
                            <input size="30" type="text" value="" class="form-control" id="fhasta" name="fhasta" readonly>
                            <span class="add-on"><i class="fa fa-calendar icon-th hidden"></i></span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-12 p-t-20 text-center">
                      <button type="button" onclick="validar();" class="btn btn-round btn-success"><i class="fa fa-print"></i> Generar</button>
  ...
  <script src="<?php echo base_url();?>js/administrador/buscar_reventafiscal.js" type="text/javascript"></script>
</body>
</html>
