...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-dark dark-sidebar-color logo-dark dark-theme">
        ...
        <div class="page-content">
          <div class="row">
            <div class="col-sm-12">
              <div class="card-box">
                <div class="card-head">
                  <header>Buscar Empresa</header>
                </div>

                <div class="card-body row">
                  <div class="col-md-6 text-center" align="center">
                    <input type="text" class="form-control" onkeyup="cargar_empresa(this.value);" placeholder="Buscar">
                  </div>
                </div>
              </div>
            </div>
  ...
  <script src="<?php echo base_url();?>js/administrador/iva.js" type="text/javascript">
  </script>
</body>
</html>
