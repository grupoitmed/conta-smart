...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-dark dark-sidebar-color logo-dark dark-theme" onload="load_empresa();">
  <div class="page-wrapper">
    ...
    <div class="page-container">
      <?php $opt = "consumidorfinal"; include "includes/menus/".$user_data['menu'];?>
      <!-- end sidebar menu -->
      <!-- start page content -->
        ...
        <div class="page-content">
          <div class="row">
            <div class="col-sm-12">
              <div class="card-box">
                <div class="card-head">
                  <header>Buscar Empresa para crear reporte de venta consumidor final</header>
                </div>
                <div class="card-body row container">
                  <form id="frm_ventafiscal" class="" action="Reporte_ventas_consumidor_final" method="POST" target="_blank">
                    <div class="row">
                    ...
                    <div class="col-lg-12 p-t-20 text-center">
                      <button type="submit" class="btn btn-round btn-success"><i class="fa fa-print"></i> Generar</button>
  ...
  <script src="<?php echo base_url();?>js/administrador/libro_compra.js" type="text/javascript">
  </script>
</body>
</html>
