  ...
  <!-- start widget -->
                    <div class="state-overview">
                            <div class="row">
                                ...
                                <!-- /.col -->
                                <div class="col-xl-3 col-md-6 col-12">
								<a href="../administracion/Proveedor" >
                                ...
                                <!-- /.col -->
                                <div class="col-xl-3 col-md-6 col-12">
								<a href="../administracion/Ingresar_empresa" >
                                ...
                                <!-- /.col -->
                                <div class="col-xl-3 col-md-6 col-12">
								<a href="../administracion/Ingresar_empresa_venta" >
                                ...
                                <!-- /.col -->
								 ...
								 <div class="col-xl-3 col-md-6 col-12">
								 <a href="../administracion/Buscar_empresa" >
                                  <div class="info-box bg-blue">
                                ...
                                <!-- /.col -->
                                <div class="col-xl-3 col-md-6 col-12">
								<a href="../administracion/Buscar_reporte_credito_fiscal" >
                                  <div class="info-box bg-orange">
                                ...
                                <!-- /.col -->
                                <div class="col-xl-3 col-md-6 col-12">
								<a href="../administracion/Libro_compras">
                                  <div class="info-box bg-purple">
                                    <span class="info-box-icon push-bottom" style="margin-top: 0px;"><i class="material-icons">assignment</i></span>
                                    <div class="info-box-content">
